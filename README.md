...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-09 19:11`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/56390649-227e-4edb-81ea-a399fc6b1f23.git
$ cd 56390649-227e-4edb-81ea-a399fc6b1f23
```
